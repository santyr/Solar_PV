...
**Data Point:**
Historical Events Log (Dec 2025)

**Analysis:**
In December 2025, the system generated repeated **"DC Over Voltage" (Event 49)** alarms.
...
*   **Action:** These specific alarms prompted the Owner to perform the manual voltage inspection documented in Exhibit E.
...
**Analysis:**
Upon discovery of the imbalance (Exhibit E), the Owner attempted to apply the correct 58.8V Fullriver profile. This immediately triggered the same "High Voltage" alarms seen in Exhibit D.
