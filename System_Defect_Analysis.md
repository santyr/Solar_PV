...
On April 12, 2025 — 3 years and 8 months after installation — the owner first adjusted charge settings while building OpenHAB monitoring software and reading the Fullriver spec sheet. The float was raised from ~53.8V to ~54.8V (closer to the Fullriver-specified 54.6V), and the absorb was raised to the Fullriver-specified 58.8V. The bank spiked to 59.19V — overshooting the target — and the owner reverted the absorb setting. The fact that the bank overshot to 59.19V when 58.8V was targeted indicates battery imbalance was **already present** at this point — the same pattern that would manifest more severely when the owner tried again in November: 60.2V (Nov 22) and 60.6V (Dec 24).
...
The owner first adjusted charge settings on **April 12, 2025** — 3 years and 8 months after installation — while building OpenHAB monitoring software and reviewing the Fullriver specification sheet. The float voltage was raised from ~53.8V to ~54.8V (closer to the Fullriver-specified 54.6V), and the absorb voltage was raised to the Fullriver-specified 58.8V. The bank immediately spiked to 59.19V — overshooting the target due to existing battery imbalance — and the owner reverted the absorb setting. In late November 2025, the owner tried again, raising the absorb back to 58.8V. The overvoltage was worse: 60.2V on Nov 22, three Event 49 alarms in December, and 60.6V by Dec 24 — forcing the owner to lower the absorb again. These changes did not cause the battery damage — the damage was caused by 3+ years of chronic undercharging at factory-default settings. Both attempts to correct the voltage to the manufacturer's specification **revealed** the existing damage and its worsening trajectory; they did not create it.
